  ...
  <div class="page-container-tdesign">
    <div class="page-header">
      <div class="page-title">
        <el-icon :size="20" color="#0052d9"><Refresh /></el-icon>
        <span>数据同步平台</span>
        <span class="page-subtitle">SeaTunnel</span>
      </div>
...
const tableData = ref([
  { id: 1, name: 'MySQL到Doris实时同步', source: 'MySQL', target: 'Doris', type: '实时', status: '运行中', updateTime: '2025-01-15 14:30:00' },
  { id: 2, name: 'Kafka到ClickHouse', source: 'Kafka', target: 'ClickHouse', type: '实时', status: '运行中', updateTime: '2025-01-15 14:25:00' },
  { id: 3, name: 'HDFS到MySQL批量', source: 'HDFS', target: 'MySQL', type: '批处理', status: '已停止', updateTime: '2025-01-15 14:20:00' },
])
